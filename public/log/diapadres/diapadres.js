...
function configurarEventos() {
    ...
    document.getElementById('diaPadreForm').addEventListener('submit', validarYConfirmar);
...
function mostrarResumen(nombre, edad, contrato, hijos) {
    ...
    document.getElementById('resumenDatos').innerHTML = `
        ...
        <hr style="margin:14px 0; border:none; border-top:1px solid #cbd5e1;">
        <p style="color:#1e40af; font-weight:700;">Por favor verifica que todos los datos sean correctos antes de confirmar.</p>
    `;
...
async function enviar() {
    ...
    try {
        ...
        const datos = {
            ...
            timestamp:      Date.now(),
            tipoEvento:     'diaDelPadre'
        };

        await addDoc(collection(window.db, 'diapadre'), datos);
